...
- In the `removeTodo` function, update the `localTodoLists` array by filtering out the todo.
...
-   └── Call addTodoDataDynamically()
-         │
-         ▼
#   [ Show Todo on Page ]

` On Refresh:`
- [ showTodoList() ] → Load from localStorage → Add to DOM again
